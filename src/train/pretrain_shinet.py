...
earlyStopping = EarlyStopping(monitor="val_CER", patience=5, mode="min", verbose=1)
...
wandbLogger = WandbLogger(
    project="shinet-pretraining",
    name="fifty-epoch-new-shinet-arch",
...
model.fit(
    ...
    initial_epoch=1,
    callbacks=[earlyStopping, modelCheckpoint, wandbLogger]
)
