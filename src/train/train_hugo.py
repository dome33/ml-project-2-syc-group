...
# LOAD THE DATASET.
train_dataset = np.load("C:\\Users\marti\Documents\BA\cr_api\ml-project-2-syc-group\src\data\synth_trainset.npy")
train_dataset = [(name, label) for name, label in train_dataset]
val_dataset = np.load("C:\\Users\marti\Documents\BA\cr_api\ml-project-2-syc-group\src\data\synth_valset.npy")
